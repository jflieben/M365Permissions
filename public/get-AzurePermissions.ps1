Function get-AzurePermissions{
    ...
    $subscription = New-GraphQuery -Uri "https://management.azure.com/subscriptions/$($subscriptionId)?api-version=2022-12-01" -Method GET -resource "https://management.azure.com/"
    ...
    $permanentPermissions = $Null; $permanentPermissions = New-GraphQuery -Uri "https://management.azure.com/subscriptions/$($subscription.subscriptionId)/providers/Microsoft.Authorization/roleAssignments?api-version=2022-04-01&`$filter=atScope()" -Method GET -resource "https://management.azure.com/"
    ...
    foreach($resourceGroup in $resourceGroups){
        ...
        $permanentPermissions = $Null; $permanentPermissions = New-GraphQuery -Uri "https://management.azure.com/subscriptions/$($subscription.subscriptionId)/resourceGroups/$($resourceGroup.name)/providers/Microsoft.Authorization/roleAssignments?api-version=2022-04-01&`$filter=atScope()" -Method GET -resource "https://management.azure.com/"
        foreach($permanentPermission in $permanentPermissions){
        ...
        foreach($resource in $resources){
            ...
            try{
                $permanentPermissions = $Null; $permanentPermissions = New-GraphQuery -Uri "https://management.azure.com/subscriptions/$($subscription.subscriptionId)/resourceGroups/$($resourceGroup.name)/providers/$($resource.type)/$($resource.name)/providers/Microsoft.Authorization/roleAssignments?api-version=2022-04-01&`$filter=atScope()" -Method GET -resource "https://management.azure.com/"
            }catch{
